<?php
	...
	{
		echo 'Enseigne : '.$_SESSION['nom_ens'].'<br/><input type="button" onclick="self.location.href=\'deco.php\'" value="Se déconnecter" /><input type="button" onclick="self.location.href=\'admin.php\'" value="Administration" />';
	}
	else
	{?>	
		<table id='tlogin'>	
